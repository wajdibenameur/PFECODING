...
## Statut d'execution
- Passe appliquee le 2026-04-23
- Compilation apres suppression: OK (`mvnw.cmd -q -DskipTests compile`)
- Tests apres suppression: OK (`mvnw.cmd -q test`)
- Candidats de cette passe conserves pour dependance inattendue: aucun
...
### Methodes effectivement supprimees
- `IntegrationClientSupport.httpOn(...)`
- `IntegrationClientSupport.timeoutOn(...)`
- `IntegrationClientSupport.invalidJsonOn(...)`
- `IntegrationClientSupport.returnedHttpDuring(...)`
...
### Packages / sous-packages effectivement supprimes
- `src/main/java/tn/iteam/cache`
- `src/main/java/tn/iteam/listener`
- `src/main/java/tn/iteam/logging`
- `src/main/java/tn/iteam/monitoring/provider`
